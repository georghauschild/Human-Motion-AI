...
public class WalkerAgentSitting : Agent
{
    [Header("Walk Speed")]
    [Range(0.1f, 10)]
    [SerializeField]
    ...
    private const string TARGET_TAG = "targetChair";
    ...
    [Header("Target To Sit")] public Transform target; //Target the agent will sit.
